...
package com.adealink.library.view.progressbar;
...
public class CircularProgressBar extends ProgressBar {
    ...
    public CircularProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int color = a.getColor(R.styleable.CircularProgressBar_cpb_color, res.getColor(R.color.color_c1));
        final float strokeWidth = a.getDimension(R.styleable.CircularProgressBar_cpb_stroke_width, res.getDimension(R.dimen.dimen_3dp));
        ...
        if (styleNormal) {
            builder.style(CircularProgressDrawable.Style.NORMAL);
        }
